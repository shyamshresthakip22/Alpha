...
function renderSidebar(leagueIndx, gameIndx) {
    ...
    <div class="upperHeader">
        <div class="sports">
            <div class="sportLogo"><img src="assets/SVGs/${leagueObject.leagueFlag}.svg" alt="" width="30" height="16"></div>${sport}</div>
        <div class="league"><img src="assets/SVGs/${leagueObject.leagueFlag}.svg" alt="" width="19" height="14" class="representLogo">${leagueObject.leagueName}</div>
    </div>
...
function replaceSidebar(leagueIndx, gameIndx) {
    ...
    <div class="upperHeader">
        <div class="sports">
            <div class="sportLogo"><img src="assets/SVGs/${leagueObject.leagueFlag}.svg" alt="" width="30" height="16"></div>${leagueObject.leagueName}</div>
        <div class="league"><img src="assets/SVGs/${leagueObject.leagueFlag}.svg" alt="" width="19" height="14" class="representLogo">${leagueObject.leagueName}</div>
    </div>
    <div class="LowerHeader">
        <div class="time"><i class="bi bi-stopwatch "></i>03/24</div>
...
function initApp() {
   ...
   `;
        ...
        <div class="gameCol2">
            <div class="betOdds ${val.btn1}" id="${indx}-${key}-1-1-wl">
               
                ${val.bets[0]}
            </div>
            <div class="betOdds ${val.btn2}" id="${indx}-${key}-1-2-wl">
                
                ${val.bets[1]}</div>
            <div class="betOdds ${val.btn3}" id="${indx}-${key}-1-3-wl">
